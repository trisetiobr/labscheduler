      ...
      <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <?php echo form_open('staff/pengajar/create'); ?>
                <div class="box-body">
                  <div class="form-group">
                    <label for="Username">*Username</label> (maksimum 25 karakter)
                    <input id="username" name="username" type="text" class="form-control field-required" placeholder="Username" maxlength="25" onBlur="checkFieldAvailability(id=this.id, target='username-help-block', controller='ajax_check_username');">
